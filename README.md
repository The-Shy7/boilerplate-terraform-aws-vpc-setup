# Creating VPCs and Subnets with Terraform

## Introduction

We will use Terraform to create a Virtual Private Cloud (VPC) with two subnets (public and private). We will also create an Internet gateway and a route table, which will be associated with our public subnet. This is a typical cloud infra configuration, separating resources into public and private subnets for improved security and control.
